...
namespace generate_flow_networks
{
    public static class Extensions
    {
        ...
        {
            return canvas.DrawString(text, width, height,
                point, angle, fontSize, foreground,
            ...
            HorizontalAlignment hAlign, VerticalAlignment vAlign)
        {
            ...
            label.HorizontalContentAlignment = hAlign;
            label.VerticalContentAlignment = vAlign;
            ...
            trans.Children.Add(new TranslateTransform(point.X, point.Y));
